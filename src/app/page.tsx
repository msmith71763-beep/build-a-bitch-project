  ...
  loading: () => (
    <div className="flex items-center justify-center w-full h-full bg-[#0a0a0c] text-white">
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-[10px] text-zinc-500 uppercase tracking-[0.3em] font-bold italic text-violet-400">Initializing V3 Engine...</p>
      </div>
    </div>
  ),
});
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-10 right-12 z-20 flex gap-4 pointer-events-none">
           <div className="px-6 py-2 bg-zinc-950/80 border border-white/5 rounded-full backdrop-blur-3xl shadow-2xl">
             <span className="text-[9px] text-violet-400/80 uppercase tracking-[0.4em] font-bold">Ultra-Stable Procedural Mode</span>
           </div>
        </div>
      </div>
