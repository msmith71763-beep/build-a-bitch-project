  ...
  loading: () => (
    <div className="flex items-center justify-center w-full h-full bg-[#0a0a0c] text-white">
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-[10px] text-zinc-500 uppercase tracking-[0.3em] font-bold italic text-violet-400">Initializing Customizer...</p>
      </div>
    </div>
  ),
});
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-10 left-12 z-20 pointer-events-none">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[9px] text-zinc-600 uppercase mt-1">Procedural Engine Stable</p>
          </div>
        </div>
      </div>
